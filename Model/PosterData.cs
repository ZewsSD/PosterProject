...
namespace Poster.Model
{
    class PosterData
    {
        ...
        public /*IReadOnly*/Hall GetHall(int id)
        {
            using (PosterDbContext db = new PosterDbContext())
            {
        ...
        public /*IReadOnly*/Session GetSession(int id)
        {
            using (PosterDbContext db = new PosterDbContext())
            {
        ...
        public IReadOnlyList</*IReadOnly*/Movie> GetAllMovies()
        {
            using (PosterDbContext db = new PosterDbContext())
            {
                return db.Movies.Include(x => x.ActorMovies).ToList();
            }
        }

        public /*IReadOnly*/Movie GetMovie(int id)
        {
            using (PosterDbContext db = new PosterDbContext())
            {
        ...
        public IReadOnlyList</*IReadOnly*/Ticket> GetAllTickets()
        {
            using (PosterDbContext db = new PosterDbContext())
            {
        ...
        public /*IReadOnly*/Ticket GetTicket(int id)
        {
            using (PosterDbContext db = new PosterDbContext())
            {
        ...
        public /*IReadOnly*/List</*IReadOnly*/Actor> GetAllActors()
        {
            using (PosterDbContext db = new PosterDbContext())
            {
                return db.Actors./*Include(x => x.ActorMovies).*/ToList();
            }
        }
